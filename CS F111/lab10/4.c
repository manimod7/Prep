//Q.4 Write a program to implement the Case study for evaluating answers in an Online Exam. Take input the Key, and the Responses of students. Display the scores of each student and the responses that are wrong. *
#include <stdio.h>
#define STUDENTS 3
#define ITEMS 5
int main()
